...
setup_contracts() {
  ...
  cleos set code eosio /telos.contracts/eosio.system/eosio.system.wasm
  sleep 1
  cleos set abi eosio /telos.contracts/eosio.system/eosio.system.abi
  sleep 1

  # Deploy eosio.token and eosio.msig contracts
  cleos set contract eosio.token /telos.contracts/eosio.token/
